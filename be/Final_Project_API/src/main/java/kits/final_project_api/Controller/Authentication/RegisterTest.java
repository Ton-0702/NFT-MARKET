...
@RestController
@CrossOrigin
@RequestMapping("api/register-test/connect-wallet")
public class RegisterTest {
    @Autowired
    private UtilsService utilsService;
    ...
    @PostMapping
    public ResponseEntity<RegisterResponseDto> registerCreateAccount(@Valid @RequestBody AccountCreateConnectWalletDTO accountCreateConnectWalletDTO,
